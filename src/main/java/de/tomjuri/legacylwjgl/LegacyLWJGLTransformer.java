...
public class LegacyLWJGLTransformer implements IClassTransformer {
    @Override
        ...
        if (name.equals("org.lwjgl.nanovg.NanoVGGLConfig")) {
            ...
            for (MethodNode method : node.methods) {
                if (method.name.equals("configGL")) {
                    ...
                    list.add(new TypeInsnNode(Opcodes.NEW, "de/tomjuri/legacylwjgl/LWJGL2FunctionProvider"));
                    list.add(new InsnNode(Opcodes.DUP));
                    list.add(new MethodInsnNode(
                            Opcodes.INVOKESPECIAL,
                            "de/tomjuri/legacylwjgl/LWJGL2FunctionProvider",
                            "<init>",
                            "()V",
                            false
                    ));
